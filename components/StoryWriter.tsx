...
function StoryWriter() {
  ...
  useEffect(() => {
    if (runFinished) {
      toast.success('Story generated successfully!', {
        action: (
          <Button onClick={() => router.push('/stories')} className='bg-purple-800 ml-auto'>
            View Stories
          </Button>
        ),
      });
  ...
  return (
    <div className='flex flex-col container bg-slate-800 text-white'>
      ...
      <div className='flex-1 pb-5 mt-5'>
        ...
        <div className='flex flex-col-reverse w-full space-y-2 bg-black rounded-md text-green-500 font-mono p-10 h-96 overflow-y-scroll'>
          <div>
            {runFinished === null && (
              <>
